...
function codeList(values: readonly string[]): TemplateResult {
  return html`
    <span style="display:flex;flex-wrap:wrap;gap:var(--ds-space-1)"> ${values.map((value) => code(value))} </span>
  `;
}
...
const spacingRows: readonly UtilityRow[] = [
  ...
  {
    group: 'Padding top/right/bottom/left',
    classes: ['.ds-pt-{n}', '.ds-pr-{n}', '.ds-pb-{n}', '.ds-pl-{n}'],
    mapsTo: 'logical side padding',
  },
  ...
  { group: 'Margin block', classes: ['.ds-my-{n}'], mapsTo: 'margin-block' },
  {
    ...
    classes: ['.ds-mt-{n}', '.ds-mr-{n}', '.ds-mb-{n}', '.ds-ml-{n}'],
    mapsTo: 'logical side margin',
  },
...
const sizingRows: readonly UtilityRow[] = [
  ...
  {
    group: 'Width keywords',
    classes: ['.ds-w-auto', '.ds-w-full', '.ds-w-screen', '.ds-w-min', '.ds-w-max', '.ds-w-fit'],
    mapsTo: 'width',
  },
  {
    group: 'Height keywords',
    classes: ['.ds-h-auto', '.ds-h-full', '.ds-h-screen', '.ds-h-min', '.ds-h-max', '.ds-h-fit'],
    mapsTo: 'height',
  },
  {
    group: 'Min width',
    classes: ['.ds-min-w-0', '.ds-min-w-full', '.ds-min-w-min', '.ds-min-w-max'],
    mapsTo: 'min-width',
  },
  { group: 'Min height', classes: ['.ds-min-h-0', '.ds-min-h-full', '.ds-min-h-screen'], mapsTo: 'min-height' },
  {
    group: 'Max width',
    classes: ['.ds-max-w-full', '.ds-max-w-none', '.ds-max-w-min', '.ds-max-w-max'],
    mapsTo: 'max-width',
  },
...
const layoutRows: readonly UtilityRow[] = [
  {
    group: 'Display',
    classes: ['.ds-d-block', '.ds-d-inline-block', '.ds-d-flex', '.ds-d-inline-flex', '.ds-d-grid', '.ds-d-none'],
    mapsTo: 'display',
  },
  ...
  {
    group: 'Align items',
    classes: ['.ds-items-start', '.ds-items-center', '.ds-items-end', '.ds-items-stretch'],
    mapsTo: 'align-items',
  },
  {
    group: 'Justify content',
    classes: ['.ds-justify-start', '.ds-justify-center', '.ds-justify-end', '.ds-justify-between'],
    mapsTo: 'justify-content',
  },
  {
    group: 'Align content',
    classes: ['.ds-content-start', '.ds-content-center', '.ds-content-end', '.ds-content-between'],
    mapsTo: 'align-content',
  },
  {
    group: 'Align self',
    classes: ['.ds-self-start', '.ds-self-center', '.ds-self-end', '.ds-self-stretch'],
    mapsTo: 'align-self',
  },
];
...
const typographyRows: readonly UtilityRow[] = [
  ...
  {
    group: 'Font weight',
    classes: ['.ds-font-normal', '.ds-font-medium', '.ds-font-semibold', '.ds-font-bold'],
    mapsTo: '--ds-font-weight-*',
  },
  {
    group: 'Line height',
