...
const GROUPS: Group[] = [
  {
    ...
    swatches: [
      { token: '--ds-color-bg', label: 'Background', desc: 'Page canvas. Base layer for all content.' },
      {
        ...
        desc: 'Cards, sidebars, input fills, zebra stripes.',
      },
      {
        token: '--ds-color-bg-muted',
        label: 'Background muted',
        desc: 'Dividers, table row separators, skeleton loaders.',
      },
      {
        token: '--ds-color-bg-inverse',
        label: 'Background inverse',
        desc: 'Reverse surface for tooltips and dark panels.',
      },
    ],
  },
  {
    ...
    swatches: [
      { token: '--ds-color-fg', label: 'Foreground', desc: 'Primary text and icons. Always passes APCA on bg.' },
      {
        ...
        desc: 'Secondary text, descriptions, placeholder copy.',
      },
  ...
  },
  {
    ...
    swatches: [
      ...
      {
        token: '--ds-color-accent-fg',
        label: 'Accent foreground',
        desc: 'Text and icons placed on solid accent backgrounds.',
      },
      {
        token: '--ds-color-accent-subtle',
        label: 'Accent subtle',
        desc: 'Tinted fill: selected rows, active nav items, badges.',
      },
    ],
  },
  {
    ...
    swatches: [
      ...
      {
        token: '--ds-color-border-strong',
        label: 'Border strong',
        desc: 'Heavier outlines for inputs, modals, drawers.',
      },
      {
        token: '--ds-color-border-subtle',
        label: 'Border subtle',
        desc: 'Very light structural lines. Row dividers in tables.',
      },
  ...
  },
  {
    ...
    swatches: [
      ...
      {
        token: '--ds-color-success-subtle',
        label: 'Success subtle',
        desc: 'Tinted background for success banners and badges.',
      },
      { token: '--ds-color-warning', label: 'Warning', desc: 'Caution, non-blocking issues, degraded states.' },
      {
        token: '--ds-color-warning-subtle',
        label: 'Warning subtle',
        desc: 'Tinted background for warning banners and badges.',
      },
      { token: '--ds-color-danger', label: 'Danger', desc: 'Errors, destructive actions, critical alerts.' },
      {
        token: '--ds-color-danger-subtle',
        label: 'Danger subtle',
        desc: 'Tinted background for error banners and badges.',
      },
    ],
  },
  {
...
const PAIRINGS = [
  {
    ...
    sample: 'Main body text, headings, icons.',
  },
  {
    bg: '--ds-color-bg',
    fg: '--ds-color-fg-muted',
    label: 'Muted on background',
    sample: 'Secondary text, descriptions, placeholder copy.',
  },
  {
    bg: '--ds-color-bg-subtle',
    fg: '--ds-color-fg',
    label: 'Primary on subtle',
    sample: 'Content inside cards, sidebars, and tinted panels.',
  },
  {
    bg: '--ds-color-accent',
    fg: '--ds-color-accent-fg',
    label: 'Accent foreground on accent',
    sample: 'Filled primary buttons, active badges, selected chips.',
  },
  {
    bg: '--ds-color-bg-inverse',
    fg: '--ds-color-fg-inverse',
    label: 'Inverse on inverse background',
    sample: 'Tooltip text, dark overlay panels, reverse banners.',
  },
];
