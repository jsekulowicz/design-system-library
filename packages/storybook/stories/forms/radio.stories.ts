...
export const Group: Story = {
  render: () => html`
    <fieldset style=${FIELDSET_BOX}>
      ...
      <ds-radio name="cadence" radio-value="monthly" checked>Monthly</ds-radio>
      <ds-radio name="cadence" radio-value="quarterly">Quarterly</ds-radio>
      <ds-radio name="cadence" radio-value="yearly">Yearly (save 20%)</ds-radio>
    </fieldset>
  `,
};
...
export const Disabled: Story = {
  render: () => html`
    <div style="display:grid;gap:var(--ds-space-2)">
      <ds-radio name="disabled-demo" radio-value="a" checked disabled>Checked and disabled</ds-radio>
      <ds-radio name="disabled-demo" radio-value="b" disabled>Unchecked and disabled</ds-radio>
    </div>
  `,
};
  ...
  render: () => html`
    <ds-card style="max-inline-size: 22rem">
      ...
      <div style="display:grid;gap:var(--ds-space-5)">
        ...
        <ds-radio name="wrapping" radio-value="short">Short label, one line</ds-radio>
      </div>
    </ds-card>
  `,
};
