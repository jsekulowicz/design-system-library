...
export class DsMenuItem extends DsElement {
  static override styles = [...DsElement.styles, optionRowStyles, menuItemStyles];
  ...
  #renderCheck(): TemplateResult {
    return html`<svg class="check" part="check" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
      <path
        fill-rule="evenodd"
